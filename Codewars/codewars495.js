...
// PREP
// Parameters:
// we are givven an array and a number. 
// results:
// are to return the number that needs to be added to the array to make the average come out to the given number.

// for example (1 + 2 + 3 + x)/4 = newAvg

// so we multiply newAvg by (arr.length + 1) then subtract the sum of arr and return that  value.
