...
// PREP
// split the string into words by spaces, split the words into letters then join then with the separator then join the words back into a sentance with spaces
...
//   I like the solutions using .map() I didn't even think of using that