...
// pseudocode:
// since the kata asks for the first place in the array that the left and rights equal each other, we can use an if statement. as in - if left and right are equal return index. else try the next index. this will be inside a for loop the length of the arr. 



function findEvenIndex(arr){
    for(let i = 0; i < arr.length; i++){
        console.log("i=", i, arr.slice(0,i).reduce((acc,c) => acc + c,0), arr.slice(i+1).reduce((acc,c) => acc + c,0) )
