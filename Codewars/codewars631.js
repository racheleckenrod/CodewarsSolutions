...
// PREP
// Parameters:
// we are given an array of integers and a target number.
// Return:
// we are  to return a number of operations that the smallest integers in the array are added together to reach or exceed the target value.
// Example:
// given [1,2,3,4,5], 9
// 1+2 = 3 + 3 = 6 + 4 = 10 now 10 is greater than nine and it took three operations, so we return 3.
// Pseudocode:
// sort array, add one number at a time, increase count with each addition and return count as soon as sum is equal to or greater than the target value
