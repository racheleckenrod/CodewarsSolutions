...
// PREP
// Parameters-
// given the floor number
// Results- 
// return a string that contains (floor number - 1) "Aa~ "'s, then a Pa!, and then if the floor number is less than 7 an "Aa!"
// examples - 3... returns "Aa~ Aa~ Aa~ Pa! Aa!"
