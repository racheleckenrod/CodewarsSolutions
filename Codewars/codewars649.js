...
// Pseudocode:
// we want to push the average of the consecutive elements of the inner arrays.
// so arr[0][0] + arr[1][0] + arr[2][0] + arr[3][0] + arr[4][0] / arr.length
