...
//     var userSolution = typeof myFirstInterpreter === "function" ? myFirstInterpreter : typeof miniStringFuck === "function" ? miniStringFuck : interpreter;
...
//       Test.assertEquals(userSolution("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++.+++++++..+++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++.+++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++."), "Hello, World!");
//       // Outputs the uppercase English alphabet
//       Test.assertEquals(userSolution("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+.+."), "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
//     });
//   });

// PREP
// P: we are given a string of the two chars "+" and "." 
// R: we are to return a string that interprets them as the character represented by the code point value. when the value reaches 256 it wraps around to zero.
// E: if given "++++++.+.+." we are to return the values of codePointAt(6) + codePointAt(7) + codePointAt(8) or "ACK + BEL + BS"
// P: make a variable that holds the number of "+"'s and push the codePointAt() that number each time we encounter a ".", making sure that 256 + 1 = 0.
...
function myFirstInterpreter(code) {
    ...
    for (let i = 0; i < code.length; i++) {
        if (code[i] === "+" && value === 255) {
            ...
            output.push(fromCharCode(value))
        }
