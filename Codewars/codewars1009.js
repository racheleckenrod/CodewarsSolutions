...
//     let jack = new Person('Jack');
//     let jill = new Person('Jill');
//     assert.strictEqual(jack.greet('Jill'), 'Hello Jill, my name is Jack', `new Person('Jack').greet('Jill')`);
//     assert.strictEqual(jill.greet('Jack'), 'Hello Jack, my name is Jill', `new Person('Jill').greet('Jack')`);
//   });
// });
