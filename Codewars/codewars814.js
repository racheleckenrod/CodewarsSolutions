...
// PREP 
// Parameters: we are given a distance (to the moon) 
// we are to return the number of folds in a paper needed to reach the distance. 
// example: paper is 0.0001m to go 10m, would need to fold(double) the paper 
